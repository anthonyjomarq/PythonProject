# USE THIS SCRIPT BY MEMBER "B" OF YOUR TEAM TO TEST THE CODE
import turtle
...
def main():
    ...
    print(stats.greater_than(parser.city_data, 'day_of_week', 'division', 4))
    print(stats.less_than(parser.city_data, 'day_of_week', 'division', 2))
